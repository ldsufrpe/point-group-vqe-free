...
def run_case(key, log, rows, smoke=False):
    ...
    rows.append(dict(molecule=tag, full_group=gname, abelian_group=mol.groupname,
    ...
    log.record(parameters=dict(molecule=tag, filter="none", group=gname,
                               n_amplitudes=counts["none"]["total"], basis="sto-3g"),
    ...
    for name, proj in (("abelian", proj_abel), ("full", proj_full)):
        ...
        log.record(parameters=dict(molecule=tag, filter=name, group=gname,
                                   n_amplitudes=counts[name]["total"], basis="sto-3g"),
...
FIELDS = ["molecule", "full_group", "abelian_group", "group_order", "abelian_order",
